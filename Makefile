...
install:
	...
	cp iconos/sembrando.png $(DESTDIR)/usr/share/icons/hicolor/96x96/apps/
	cp lanzador/Sembrando\ para\ el\ futuro.desktop $(DESTDIR)/usr/share/applications/
	cp lanzador/sembrando $(DESTDIR)/usr/bin/
...
# se creó en el install
	...
	rm $(DESTDIR)/usr/share/icons/hicolor/96x96/apps/sembrando.png
