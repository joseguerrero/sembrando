...
class Vocabulario:
    ...
    def __init__(self):
        ...
        self.dic = {
            "absorber": ("a_absorver", 385 + 20),
            "rsexual": ("a_sexual", 370 + 20),
            "rasexual": ("a_asexual", 323 + 20),
            "fotosintesis": ("a_fotosintesis", 1150 + 20),
            "celula": ("a_celula", 1018 + 20),
            "componentes": ("a_componentes", 350),
            "germinacion": ("a_germinar", 367 + 20),
            "minerales": ("a_minerales", 565 + 20),
            "nutrientes": ("a_nutrientes", 1431 + 20),
            "organo": ("a_organo", 578 + 20),
            "transformacion": ("a_transformacion", 441 + 20),
            "transportar": ("a_transporte", 443 + 20),
        }

        self.diccolor = {
            "0": ((1, 0.604, 0, 1), (1, 0.604, 0, 1)),
            "1": ((1.0, 0.09084, 0.319, 1), (0.212, 0.002428, 0.03434, 1)),
            "2": ((0.242, 0.73, 0.242, 1), (0.03955, 0.631, 0.209, 1)),
        }
...
class Interprete:
    ...
    def mover_palabra(self):
        ...
        """
        palabra = self.scena.objects[
            self.palabra
        ]  # define el objeto q se movera (palabra)
